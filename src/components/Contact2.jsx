...
const socials = [
  { name: "LinkedIn", href: "https://www.linkedin.com/in/mohamed-wael-9639bb344/" },
  { name: "Github", href: "https://github.com/mohamedwaell" },
];
...
const Contact = () => {
  return (
    ...
    >
      <div className="md:w-[96%] w-full h-[95%] flex flex-col items-center justify-center   m-auto md:p-5 rounded-xl  bg-[#a47cf3] overflow-hidden">
        ...
        <div className="md:w-[85%] w-full  m-auto h-[68%] flex gap-5 md:flex-row flex-col md:text-xl heading items-center justify-around  text-black ">
          ...
          <div className="md:w-[20%] w-full gap-5 flex md:flex-col   justify-center items-center   ">
            <button
              onClick={() =>
                (window.location.href = "mailto:mhamedwaell22@gmail.com")
              }
              className="border semiheading-h1 bg-black text-[#a47cf3] px-7 py-3 flex items-center justify-center gap-1 rounded-full"
            >
              <CiMail /> Email
            </button>
            <button
              onClick={() =>
                window.open(
                  "https://wa.me/201063253503?text=let's%20build%20something%20amazing%20together!",
                )
              }
              className="border semiheading-h1  bg-black text-[#a47cf3] px-6 py-3 flex items-center justify-center gap-1 rounded-full"
            >
              <FaWhatsapp /> WhatsApp
            </button>
          </div>
